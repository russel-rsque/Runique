package com.rosique.wear.run.presentation.ambient
...
private fun rememberBurnInTranslation(
    isAmbientMode: Boolean,
    burnInProtectionRequited: Boolean
): State<Float> {
    ...
    LaunchedEffect(isAmbientMode, burnInProtectionRequited) {
        if (isAmbientMode && burnInProtectionRequited) {
