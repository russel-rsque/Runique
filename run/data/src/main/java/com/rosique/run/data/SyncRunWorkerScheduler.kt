...
import com.rosique.core.mappers.toRunEntity
...
class SyncRunWorkerScheduler(
    ...
    override suspend fun scheduleSync(type: SyncRunScheduler.SyncType) {
        when(type) {
            ...
            is SyncRunScheduler.SyncType.DeleteRun -> scheduleDeleteRunWorker(
                runId = type.runId
            )
            is SyncRunScheduler.SyncType.FetchRuns -> scheduleFetchRunsWorker(
